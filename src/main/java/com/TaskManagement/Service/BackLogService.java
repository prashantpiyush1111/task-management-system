...
public class BackLogService {
	...
	public List<Issue> getBackLog(Long projectId, Long organizationId) {
	...
	@Transactional
	public void recorderBackLog(Long projectId, List<Long> orderedIssueId, Long organizationId) {
		int pos = 0;
	...
	@Transactional
	public Issue addIssueToSprint(Long issueId, Long sprintId, Long organizationId) {
		Issue issue = issueRepo.findById(issueId).orElseThrow(() -> new RuntimeException("Issue not found"));
		if (!organizationId.equals(issue.getOrganizationId())) {
			throw new RuntimeException("Issue not found");
		}
	...
	public Map<String, Object> getBackLogHierArchy(Long projectId, Long organizationId) {
		List<Issue> backLog = getBackLog(projectId, organizationId);
